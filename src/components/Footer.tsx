    ...
    <footer className="bg-white text-md text-gray-600">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="border-t border-gray-200 mt-16 pt-8 space-y-6 text-md text-gray-500">
          ...
          <p>
            eToro (Seychelles) Ltd. is licensed by the Financial Services Authority Seychelles ("FSAS") to provide broker-dealer services under the Securities Act 2007 License #SD076. Registered Office: Suite 18, 3rd Floor, Vairam Building, Providence, Mahe, Seychelles.
          </p>
          <p>
            eToro (ME) Limited, is licensed and regulated by the Abu Dhabi Global Market (“ADGM”)'s Financial Services Regulatory Authority ("FSRA") as an Authorised Person to conduct the Regulated Activities of (a) Dealing in Investments as Principal (Matched), (b) Arranging Deals in Investments, (c) Providing Custody, (d) Arranging Custody and (e) Managing Assets under the Financial Services and Markets Regulations 2015 (“FSMR”). Its registered office and its principal place of business is at Office 207 and 208, 15th Floor, Al Sarab Tower, ADGM Square, Al Maryah Island, Abu Dhabi, United Arab Emirates (“UAE”).
          </p>
          <p>
